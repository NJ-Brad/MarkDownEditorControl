...
namespace MarkDownHelper
{
    public partial class PropertyTable : UserControl
    {
        ...
        //        {
        //            PropertyInfo pInfo = t.GetProperty(ctrl.Tag.ToString());
        //            string val = GetCtrlValue(ctrl);

        //            pInfo.SetValue(dataObject, val);
        //        }
        //    }
        //}

        //private void ObjectToTable()
        //{
        //}
